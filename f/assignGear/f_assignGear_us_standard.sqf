// F3 - Folk ARPS Assign Gear Script - US Army - Standard Loadout
...
switch (_typeofUnit) do
{
	...
	case "ar":
	{
		...
		_unit addweapon _AR;
		_attachments pushback ("LIB_M1918A2_BAR_Bipod");
