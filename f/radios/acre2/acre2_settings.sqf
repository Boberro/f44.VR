...
f_radios_settings_acre2_extraRadios = ["radio", "jtac", "vc"];
...
// This means more radio messages go through (No radio signal loss due to antennas being out of alignment)
